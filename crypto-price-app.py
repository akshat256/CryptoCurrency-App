...
def load_data():
    ...
    volume_24h = []
    for i in range(100):
        coin_name.append(listings[i][35])
        coin_symbol.append(listings[i][36])
        price.append(listings[i][26])
        percent_change_1h.append(listings[i][20])
        percent_change_24h.append(listings[i][21])
        percent_change_7d.append(listings[i][24])
        market_cap.append(listings[i][17])
        volume_24h.append(listings[i][29])
